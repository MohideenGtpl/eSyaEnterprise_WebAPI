...
namespace eSyaConfigSetup.DL.Entities
{
    public partial class GtEcfmfd
    {
        public GtEcfmfd()
        {
            GtEcdccn = new HashSet<GtEcdccn>();
            GtEcfmal = new HashSet<GtEcfmal>();
            GtEcfmnm = new HashSet<GtEcfmnm>();
            GtEcfmpa = new HashSet<GtEcfmpa>();
        ...
        public virtual ICollection<GtEcdccn> GtEcdccn { get; set; }
        public virtual ICollection<GtEcfmal> GtEcfmal { get; set; }
        public virtual ICollection<GtEcfmnm> GtEcfmnm { get; set; }
        public virtual ICollection<GtEcfmpa> GtEcfmpa { get; set; }
