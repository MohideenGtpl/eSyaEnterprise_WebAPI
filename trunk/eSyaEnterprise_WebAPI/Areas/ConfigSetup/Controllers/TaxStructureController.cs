...
namespace eSyaEnterprise_WebAPI.Areas.ConfigSetup.Controllers
{
    ...
    public class TaxStructureController : ControllerBase
    {
        ...
        /// <summary>
        /// Active Or De Active Tax Structure.
        /// UI Reffered - Tax Structure
        /// </summary>
        /// <param name="status-Isd_code-Taxcode"></param>
        /// <returns></returns>
        [HttpGet]
        public async Task<IActionResult> ActiveOrDeActiveTaxStructure(bool status, int Isd_code, int Taxcode)
        {
            var msg = await _TaxStructureRepository.ActiveOrDeActiveTaxStructure(status, Isd_code, Taxcode);
            return Ok(msg);
        }
    }
}