...
namespace eSyaEnterprise_WebAPI.Areas.ConfigSetup.Controllers
{
    ...
    public class LocalizationController : ControllerBase
    {
        ...
        /// <summary>
        /// Active Or De Active Localization Table Master.
        /// UI Reffered - Localization Table Master
        /// </summary>
        /// <param name="status-Tablecode"></param>
        /// <returns></returns>
        [HttpGet]
        public async Task<IActionResult> ActiveOrDeActiveLocalizationTableMaster(bool status, int Tablecode)
        {
            var msg = await _LocalizationMasterRepository.ActiveOrDeActiveLocalizationTableMaster(status, Tablecode);
            return Ok(msg);
        }
        #endregion
        ...
        /// <summary>
        /// Active Or De Active Language Controller.
        /// UI Reffered -Language Controller
        /// </summary>
        /// <param name="status-ResourceId"></param>
        /// <returns></returns>
        [HttpGet]
        public async Task<IActionResult> ActiveOrDeActiveLanguageController(bool status, int ResourceId)
        {
            var msg = await _LocalizationMasterRepository.ActiveOrDeActiveLanguageController(status, ResourceId);
            return Ok(msg);
        }
