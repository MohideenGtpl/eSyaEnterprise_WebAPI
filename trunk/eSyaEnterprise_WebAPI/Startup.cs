...
namespace eSyaEnterprise_WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISMSEngineRepository, SMSEngineRepository>();
            services.AddScoped<ITaxIdentificationRepository, TaxIdentificationRepository>();
            services.AddScoped<ITemplateCreatorRepository, TemplateCreatorRepository>();
            services.AddScoped<IMobilePannelRepository, MobilePannelRepository>();
